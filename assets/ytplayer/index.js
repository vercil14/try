...
var loadScript = function(a, b, c) {
    ...
    $Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0 = function(a, b) {
...
$jscomp.inherits($Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0, EventEmitter);
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.indexOf = function(a, b) {
    for (var c = 0, d = a.length, e = -1, f = !1; c < d && !f;) a[c] === b && (e = c, f = !0), c++;
    return e
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.load = function(a, b, c) {
    b = void 0 === b ? !1 : b;
    c = void 0 === c ? 0 : c;
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.replayFrom = function(a) {
    var b = this;
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.seek = function(a) {
    this._ready ? this._player.seekTo(a, !0) : this._queueCommand("seek", a)
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._optimizeDisplayHandler = function(a) {
    if (this._player) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.stopReplay = function(a) {
    for (var b = $jscomp.makeIterator(this.replayInterval.entries()), c = b.next(); !c.done; c = b.next()) {
        c = $jscomp.makeIterator(c.value);
        var d = c.next().value;
        c.next();
        Object.hasOwnProperty.call(this.replayInterval, d) && a === this.replayInterval[d].iframeParent && (clearInterval(this.replayInterval[d].interval),
            this.replayInterval.splice(d, 1))
    }
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.setVolume = function(a) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.setLoop = function(a) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.setSize = function(a, b) {
    this._ready ? this._player.setSize(a, b) : this._queueCommand("setSize", a, b)
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.setPlaybackRate = function(a) {
    this._ready ? this._player.setPlaybackRate(a) : this._queueCommand("setPlaybackRate", a)
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype.setPlaybackQuality = function(a) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._destroy = function(a) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._queueCommand = function(a, b) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._loadIframeAPI = function(a) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._createPlayer = function(a) {
    var b = this;
    if (!this.destroyed) {
        var c = this._opts;
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._onReady = function(a) {
    this.destroyed || (this._ready = !0, this.load(this.videoId, this._autoplay, this._start), this._flushQueue())
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._onStateChange = function(a) {
    if (!this.destroyed) {
...
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._onPlaybackQualityChange = function(a) {
    this.destroyed || this.emit("playbackQualityChange", a.data)
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._onPlaybackRateChange = function(a) {
    this.destroyed || this.emit("playbackRateChange", a.data)
};
$Users$vagrant$workspace$Mobirise5_emac_Release$Release$release$mac$Mobirise_app$Contents$Resources$_app_asar$web$app$themes$mobirise5$plugins$ytplayer$index$classdecl$var0.prototype._onError = function(a) {
